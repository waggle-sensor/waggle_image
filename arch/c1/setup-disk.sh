...
# install packages
while ! yes | pacman --disable-download-timeout -S uboot-tools rsync git openbsd-netcat networkmanager modemmanager mobile-broadband-provider-info usb_modeswitch python3 openssh docker screen; do
