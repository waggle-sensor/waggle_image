...
#
# Clean-up process to convert ubuntu image into an ubuntu server image
#
# Motivation: Manufacturer does not always provide a server image. Building server image from scratch is not trivial.
